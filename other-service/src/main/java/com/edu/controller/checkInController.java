...
//    @PostMapping("/add")
//   ResultVo<Boolean>  add(String customername,Integer customerage,Integer customersex,String idcard,String roomid,String buildingid,String recordid,Integer eldertype,String checkindate,String expirationdate,String contacttel,String remarks,String nursingLevel)throws InterruptedException {
...
@PostMapping("/del")
    ...
    ResultVo<Boolean>  checkoutbanli(String recordid,Integer checkouttype,String checkoutreason,String checkoutdate,String asktime,String checkoutremarks) throws InterruptedException {
    ...
    ResultVo<Boolean>  goOutbanli(String recordid,String gooutreason,String goouttime,String wantbacktime,String companions,String relationship,String companionstel,String gooutremarks) throws InterruptedException {
