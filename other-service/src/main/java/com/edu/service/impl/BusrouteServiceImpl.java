...
import com.edu.mapper.BusrouteMapper;
...
public class BusrouteServiceImpl extends ServiceImpl<BusrouteMapper, Busroute> implements BusrouteService {
    ...
    @Override
    public Boolean add(String name, String bustime, String route) {
        return this.save(new Busroute(name,bustime,route));
    }

    @Override
    public boolean update(Integer id, String name, String bustime, String route) {
